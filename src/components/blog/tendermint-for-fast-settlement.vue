...
<template><article>
<section id="section-top">  <div class="section-container">    <h1>Tendermint for Fast Settlement</h1>    <p>October 3, 2015</p>  </div></section><section class="section-default">  <div class="section-container">    <div class="section-content">      <div class="article-body"><p>Some experts in the nascent blockchain industry have said the following:</p>
<ul>
