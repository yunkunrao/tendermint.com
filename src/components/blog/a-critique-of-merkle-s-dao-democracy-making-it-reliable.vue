...
<template><article>
<section id="section-top">  <div class="section-container">    <h1>A Critique of Merkle's DAO Democracy: Making it Reliable</h1>    <p>June 6, 2016</p>  </div></section><section class="section-default">  <div class="section-container">    <div class="section-content">      <div class="article-body"><h2>Merkle's New DAO Paper</h2>
