...
<h2>Fin</h2>
<ul>
<li>Go to http://tendermint.com and sign up for the newsletter.</li>
...
export default {
  ...
  data () {
    return {
      ...
      twitterUrl: `https://twitter.com/home?status=Cases%20for%20Tendermint%20${window.location.href}`
    }
  },
  head: {
    title: {
      inner: 'Cases for Tendermint'
    }
  }
}
</script>
