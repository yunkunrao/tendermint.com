...
<template><article>
  ...
  <div class="article-wrapper">
    <h1>Sidechains without Pegging</h1>

    <div class="subtitle">November 25, 2014</div>

<p>There is an interesting debate happening between Bitcoin maximalists and the rest of the cryptocurrency community.</p>
