...
<section id=section-top>
  <div class=section-container>
    <h1> Source Code</h1>
    <p>Develop on Tendermint&#x2019;s open source platform. Start learning with <router-link to=/guide>the guide</router-link>.</p>
    </div>
            ...
            <div class=panel-body>
              <ul>
                <li><a href=http://github.com/tendermint/tendermint/wiki>
                  ...
                  <p>Get an overview of Tendermint&#x2019;s structure, algorithms, and roadmap.</p>
                </a></li>
