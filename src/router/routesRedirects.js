export default [
  ...
  { path: '/intro/getting-started/first-abci-app',
    redirect: '/intro/getting-started/first-app' },
  { path: '/intro/getting-started/install',
    redirect: '/intro/getting-started/download-tendermint' },
  { path: '/intro/getting-started/download', redirect: '/intro/getting-started/download-tendermint' },
  { path: '/intro/download-tendermint', redirect: '/intro/getting-started/download-tendermint' },
