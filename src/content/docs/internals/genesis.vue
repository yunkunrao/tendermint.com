...
<li><code>validators</code>:
<ul>
<li><code>pub_key</code>: The first element specifies the pub_key type. 1 == Ed25519.  The second element are the pubkey bytes.</li>
<li><code>amount</code>: The validator&#x2019;s voting power.</li>
