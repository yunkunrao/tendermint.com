...
<template><article>
<section id="section-top">  <div class="section-container">    <h1>On TheDAO and Proof-of-Stake Governance</h1>    <p>June 21, 2016</p>  </div></section><section class="section-default">  <div class="section-container">    <div class="section-content">      <div class="article-body"><h2>Introduction</h2>
...
<h3>The DAO Wars</h3>
<p>&lt;blockquote class=&quot;twitter-tweet&quot; data-lang=&quot;en&quot;&gt;&lt;p lang=&quot;en&quot;
...
href=&quot;https://t.co/f7zO3s1D6N&quot;&gt;pic.twitter.com/f7zO3s1D6N&lt;/a&gt;&lt;/p&gt;— Simon
...
but &lt;sup&gt;1&lt;/sup&gt;⁄&lt;sub&gt;3&lt;/sub&gt;+ can veto the majority decision by voting
with force.  When a strict majority is vetoed, everyone gets punished by losing
&lt;code&gt;VetoPenaltyFeeBlocks&lt;/code&gt; (DEFAULT 1 day’s worth of blocks) worth
...
export default {
  ...
  data () {
    return {
      ...
      twitterUrl: `https://twitter.com/home?status=On%20TheDAO%20and%20Proof-of-Stake%20Governance%20${window.location.href}`
    }
  },
  head: {
    title: {
      inner: 'On TheDAO and Proof-of-Stake Governance'
    }
  }
}
</script>
